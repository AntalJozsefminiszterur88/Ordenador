...
class MainWindow(QMainWindow):
    ...
    def _on_start_calibration(self) -> None:
        """Hide the main window and launch the calibration workflow."""
    ...
    def _start_calibration(self) -> None:
        """Start the calibration workflow on the assistant thread."""
    ...
    def _ensure_assistant_worker(self) -> bool:
        """Initialise the assistant worker thread if it's not already running."""
